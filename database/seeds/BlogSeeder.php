...
class BlogSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Blog::create([
            ...
            'thumbnail' => asset('images/article/forbes_1.jpg'),
            'files' => [asset('images/article/forbes_1.jpg'), asset('images/article/forbes_2.jpg'), asset('images/article/forbes_3.jpg')],
        ]);
