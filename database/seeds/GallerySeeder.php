    ...
    public function run()
    {
        ...
        for ($i = 0; $i < 20; $i++) {
            Gallery::create([
                ...
                'thumbnail' => asset('images/gallery/' . $y++ . '.jpeg'),
                'file' => asset('images/gallery/' . $z++ . '.jpeg')
            ]);
        }
        ...
        Gallery::create([
            ...
            'thumbnail' => asset('images/gallery/instructional-avspf.png'),
        ...
        Gallery::create([
            ...
            'thumbnail' => asset('images/home/exc_5.jpg'),
        ...
        Gallery::create([
            ...
            'thumbnail' => asset('images/home/avspf2.png'),
        ...
        Gallery::create([
            ...
            'thumbnail' => asset('images/gallery/perfect-way-to-wrap.png'),
