<ul id="m_nav_list" class="m_nav menu__list">
    ...
    <li class="dropdown menu__item menu__item--current m_nav_item {{Illuminate\Support\Facades\Request::is('product-overview*') ? 'active' : ''}}"
        id="moble_nav_item_2">
        <a href="#" class="dropdown-toggle menu__link link link--kumya" data-toggle="dropdown">
            <i class="fa fa-car" aria-hidden="true"></i><span data-letters="Products">Products<b
    ...
    <li class="m_nav_item {{Illuminate\Support\Facades\Request::is('warranty*') ? 'active' : ''}}"
        id="moble_nav_item_3">
    ...
    <li class="m_nav_item {{Illuminate\Support\Facades\Request::is('installers*') ? 'active' : ''}}"
        id="moble_nav_item_5">
    ...
    <li class="m_nav_item {{Illuminate\Support\Facades\Request::is('blog*') ? 'active' : ''}}" id="moble_nav_item_6">
