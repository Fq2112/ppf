<head>
    ...
    <title>Contact Installer: {{$con_company}}</title>
    <style type="text/css">
        /*Bootstrap*/
        .alert {
            padding: 15px;
                                    ...
                                    <table bgcolor="#fff" border="0" cellspacing="0" cellpadding="0" class="full-width"
                                        ...
                                        <tr>
                                            <td align="center" width="660">
                                                <a name="Logo" style="display:block" href="{{route('home-company')}}" target="_blank">
                                        ...
                                        <tr>
                                            <td align="center" valign="top" style="font-family:helvetica,arial,sans-serif; color:#646464; font-size:14px; line-height:22px;">
                                                <span style="font-size:20px; font-weight:bold; line-height:26px;text-align: justify">Please follow up this email with the following details.</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <table border="0" cellpadding="10" cellspacing="0" style="margin: 0 auto;text-align: justify">
                                                    <tr>
                                                        <th>Name</th>
                                                        <td>&nbsp;:&nbsp;</td>
                                                        <td>{{$con_fname.' '.$con_lname}}</td>
                                                    </tr>
                                                    <tr>
                                                        <th>Email</th>
                                                        <td>&nbsp;:&nbsp;</td>
                                                        <td><a href="mailto:{{$con_email}}" style="text-transform: none">{{$con_email}}</a></td>
                                                    </tr>
                                                    <tr>
                                                        <th>Company</th>
                                                        <td>&nbsp;:&nbsp;</td>
                                                    ...
                                                    <tr>
                                                        <th>Phone</th>
                                                        <td>&nbsp;:&nbsp;</td>
                                                        <td><a href="tel:{{$con_phone}}" style="text-transform: none">{{$con_phone}}</a></td>
                                                    </tr>
                                                    <tr>
                                                        <th>Country</th>
                                                        <th>&nbsp;:&nbsp;</th>
                                    ...
                                    <table width="700" border="0" align="center" cellspacing="0" cellpadding="0"
                                        ...
                                        <tr>
                                            ...
                                            <td align="center" valign="top" width="660" bgcolor="#1a1c21">
                                                <a name="Logo_1" style="display:block;" href="{{route('home-company')}}" target="_blank">
                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                            <table border="0" align="center" cellpadding="0"
                                                                ...
                                                                <tr>
                                                                    <td align="center"><a
                                                                            href="https://fb.com/AveryDennisonCorporation"
                                                                    ...
                                                                    <td>
                                                                        <a href="https://twitter.com/AveryDennison"
                                                                    ...
                                                                    <td>
                                                                        <a href="https://instagram.com/averydennison.id"
