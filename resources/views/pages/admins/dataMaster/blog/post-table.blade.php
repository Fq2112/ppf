...
@section('title', 'PPF Admins: Blog Posts Table | '.env('APP_TITLE'))
@push('styles')
                                ...
                                <table class="table table-striped" id="dt-buttons">
                                    ...
                                    @foreach($posts as $row)
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle" align="center">{{$row->title_uri}}</td>
                                            <td style="vertical-align: middle" align="center">
...
@push("scripts")
    ...
    <script>
        ...
        $("#btn_create").on('click', function () {
            ...
            $("#form-blogPost input[name=_method], #form-blogPost input[name=id], #form-blogPost input[name=user_id], #title").val('');
            $(".input-files").show();
